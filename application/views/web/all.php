                ...
                <?php foreach ($chunk_products as $single_products) {  ?>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="<?php echo base_url('uploads/'.$single_products->product_image)?>" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"><?php echo $single_products->product_title ?></h5>
                                    <!-- Product price-->
                                    <?php
                                    // setlocale(LC_MONETARY,"id_ID"); 
                                    echo "Rp. ".number_format($single_products->product_price, 2, ",", "."); ?>
                                </div>
                            </div>
                            <!-- Product actions-->
