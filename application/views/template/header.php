...
<head>
    ...
    <link href="<?php echo base_url(VENDOR); ?>/bootstrap/js/bootstrap.min.js" rel="stylesheet" />
    <link href="<?php echo base_url(VENDOR); ?>/bootstrap/js/bootstrap.bundle.min.js" rel="stylesheet" />
